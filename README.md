...
**Note:** InfiniBand uses pure RDMA (verbs) communication. No IP networking or IPoIB CNI is configured. Pods access InfiniBand devices directly via `/dev/infiniband` hostPath mount.
